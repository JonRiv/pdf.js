  ...
  _handler: function (req, res) {
    ...
    function serveDirectoryIndex(dir) {
      ...
      fs.readdir(dir, function (err, files) {
        ...
        res.write('<html><head><meta charset=\"utf-8\"><style>body {background: linear-gradient(hsla(0,0%,32%,.99), hsla(0,0%,27%,.95))} * {font:message-box;font-size:16px;color:white;text-decoration:none;} h1 {font-size:18px;font-weight:bold;} a:hover{color:slategrey} a:visited{color:hsla(0,0%,50%,.99)} a:visited:hover{color:slategrey} a:first-of-type {display:none;}</style></head><body>' +
                  '<h1>Pdf list :</h1>\n');
        if (pathPart !== '/') {
